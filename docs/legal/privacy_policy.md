...
- **Recent history** — recently opened videos and tracks, and your last playback session (via local `shared_preferences`)
- **Playback state** — position, speed, and related session details for resume
...
- Process payments
- Upload your videos, tracks, or subtitles to a remote service operated by us

## Sharing and export

Data stays on your device unless **you** explicitly:

- Share or export a file (for example, a VEIL track JSON or a diagnostics text report)
- Use Android “Open with” or system share features to send content elsewhere

You are responsible for what you share and with whom.
...
We may update this policy as the app evolves. Material changes should be reflected in a newer in-app version of this document.

## Contact

Questions about this policy: **allamzedan@live.com**
